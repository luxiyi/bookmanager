...
<body>
	...
	<!-- 	书籍详情 -->
	<div style="height: 50px; width: 200px; overflow: auto; position: relative; margin: 40px auto; font-size: 30px;">书籍介绍</div>
	<div class="container" id="detailbox">
		<div class="row" id="detailbook"></div>
	</div>
	<!-- 	另一页面接收参数 -->
	<!-- 可以设置一个隐藏域，将参数传入 -->
	<%--<div id="canshu">${param.bid}</div>--%>
	<div style="height: 50px; width: 200px; overflow: auto; position: relative; margin: 0 auto; font-size: 30px;">书籍评价${param.bid}</div>
	<div style="height: 50px; width: 1000px; margin: 0 auto; font-size: 15px;">
		<div class="row">
		<table class="table table-hover text-center">
					<tr>				
					<td class='infor1'>用户名</td>
					<td class='infor2'>评价时间</td>
					<td class='infor3'>评价内容</td>					
					</tr>
		</table>
		</div>
	</div>
	...
	<div data-spy="scroll" data-target="#navbar-example" data-offset="0"
		style="height: 200px; width: 1000px; overflow: auto; position: relative; margin: 0 auto;">
	...
	<div style="height: 300px; width: 800px; margin: 0 auto; font-size: 15px; padding-top: 10px; padding-left: 20px;">
		...
		<div style="width: 500px; margin: 0 400px;">
			<button class="btn btn-primary" type="submit"
				onclick="insertcomment()">评价${param.bid}</button>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
			<a href="./jsp/index.jsp"><button class="btn btn-danger">返回主界面</button></a>
		</div>
	</div>
